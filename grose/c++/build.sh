...
g++ -O3 -DNDEBUG -DEIGEN_NO_DEBUG -DEIGEN_NO_STATIC_ASSERT -I/home/grosed/DASS/ praxi.cpp example_2.o  particle.o  prior.o  theorem_1.o theorem_2.o theorem_3.o theorem_4.o dnorm.o -o praxi

g++ -O3 -DNDEBUG -DEIGEN_NO_DEBUG -DEIGEN_NO_STATIC_ASSERT -I/home/grosed/DASS/ bagel_online.cpp example_2.o  particle.o  prior.o  theorem_1.o theorem_2.o theorem_3.o theorem_4.o dnorm.o -o bagel
